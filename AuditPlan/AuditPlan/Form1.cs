...
namespace AuditPlan
{
    public partial class Form1 : Form
    {
        ...
        private void P_MS_P_IN_TB_TextChanged(object sender, EventArgs e)
        {
            try
            {
                if (P_MS_P_IN_TB.Text == String.Empty)
                {
                    P_MS_P_Prc_TB.Clear();
                }
                P_MS_P_Prc_TB.Text = (Convert.ToInt64(P_MS_P_IN_TB.Text) * 90).ToString();
        ...
        private void P_HOBC_P_IN_TB_TextChanged(object sender, EventArgs e)
        {
            try
            {
                if (P_HOBC_P_IN_TB.Text == String.Empty)
                {
                    P_HOBC_P_Prc_TB.Clear();
                }
                P_HOBC_P_Prc_TB.Text = (Convert.ToInt64(P_HOBC_P_IN_TB.Text) * 100).ToString();
                PD_TextChange();
            }
        ...
        private void P_HSD_P_IN_TB_TextChanged(object sender, EventArgs e)
        {
            try
            {
                if (P_HSD_P_IN_TB.Text == String.Empty)
                {
                    P_HSD_P_Prc_TB.Clear();
                }
                P_HSD_P_Prc_TB.Text = (Convert.ToInt64(P_HSD_P_IN_TB.Text) * 115).ToString();
                PD_TextChange();
            }
        ...
        private void P_KO_P_IN_TB_TextChanged(object sender, EventArgs e)
        {
            try
            {
                if (P_KO_P_IN_TB.Text == String.Empty)
                {
                    P_KO_P_Prc_TB.Clear();
                    P_TPSM_P_TS_TB.Clear();
                    P_TPSM_P_TA_TB.Clear();
                }
                P_KO_P_Prc_TB.Text = (Convert.ToInt64(P_KO_P_IN_TB.Text) * 110).ToString();
                P_PTotStck();
                PD_TextChange();
        ...
        private void P_KO_P_Prc_TB_TextChanged(object sender, EventArgs e)
        {
            try
            {
                P_PTotAmnt();
        ...
        private void P_MS_T_IN_TB_TextChanged(object sender, EventArgs e)
        {
            try
            {
                if (P_MS_T_IN_TB.Text == String.Empty)
                {
                    P_MS_T_Stck_TB.Clear();
                }
                P_MS_T_Stck_TB.Text = ((Convert.ToInt64(P_MS_P_IN_TB.Text) * Convert.ToInt64(P_MS_T_IN_TB.Text)) / 100).ToString();
                PD_TextChange();
            }
        ...
        private void P_HOBC_T_IN_TB_TextChanged(object sender, EventArgs e)
        {
            try
            {
                if (P_HOBC_T_IN_TB.Text == String.Empty)
                {
                    P_HOBC_T_Stck_TB.Clear();
                }
                P_HOBC_T_Stck_TB.Text = ((Convert.ToInt64(P_HOBC_P_IN_TB.Text) * Convert.ToInt64(P_HOBC_T_IN_TB.Text)) / 100).ToString();
                PD_TextChange();
            }
        ...
        private void P_HSD_T_IN_TB_TextChanged(object sender, EventArgs e)
        {
            try
            {
                if (P_HSD_T_IN_TB.Text == String.Empty)
                {
                    P_HSD_T_Stck_TB.Clear();
                }
                P_HSD_T_Stck_TB.Text = ((Convert.ToInt64(P_HSD_P_IN_TB.Text) * Convert.ToInt64(P_HSD_T_IN_TB.Text)) / 100).ToString();
                PD_TextChange();
            }
        ...
        private void P_KO_T_IN_TB_TextChanged(object sender, EventArgs e)
        {
            try
            {
                if (P_KO_T_IN_TB.Text == String.Empty)
                {
                    P_KO_T_Stck_TB.Clear();
                    P_TTS_T_TStck_TB.Clear();
                    P_VD_Stck_TB.Clear();
                    P_VD_Sale_TB.Clear();
                    P_SahiD_Stck_TB.Clear();
                    P_SahiD_Sale_TB.Clear();
                    P_SherD_Stck_TB.Clear();
                    P_SherD_Sale_TB.Clear();
                    P_Depo_TAmnt.Clear();
                    P_Depo_TStck.Clear();
                }
                P_KO_T_Stck_TB.Text = ((Convert.ToInt64(P_KO_P_IN_TB.Text) * Convert.ToInt64(P_KO_T_IN_TB.Text)) / 100).ToString();
        ...
        private void P_KO_T_Stck_TB_TextChanged(object sender, EventArgs e)
        {
            try
            {
                P_TTotStck();
        ...
        private void P_MS_S_IN_TB_TextChanged(object sender, EventArgs e)
        {
            try
            {
                if (P_MS_S_IN_TB.Text == String.Empty)
                {
                    P_MS_S_Amnt_TB.Clear();
                }
                P_MS_S_Amnt_TB.Text = (((Convert.ToInt64(P_MS_P_IN_TB.Text) * Convert.ToInt64(P_MS_S_IN_TB.Text)) / 100) * 98).ToString();
                PD_TextChange();
            }
        ...
        private void P_HOBC_S_IN_TB_TextChanged(object sender, EventArgs e)
        {
            try
            {
                if (P_HOBC_S_IN_TB.Text == String.Empty)
                {
                    P_HOBC_S_Amnt_TB.Clear();
                }
                P_HOBC_S_Amnt_TB.Text = (((Convert.ToInt64(P_HOBC_P_IN_TB.Text) * Convert.ToInt64(P_HOBC_S_IN_TB.Text)) / 100) * 116).ToString();
                PD_TextChange();
            }
        ...
        private void P_HSD_S_IN_TB_TextChanged(object sender, EventArgs e)
        {
            try
            {
                if (P_HSD_S_IN_TB.Text == String.Empty)
                {
                    P_HSD_S_Amnt_TB.Clear();
                }
                P_HSD_S_Amnt_TB.Text = (((Convert.ToInt64(P_HSD_P_IN_TB.Text) * Convert.ToInt64(P_HSD_S_IN_TB.Text)) / 100) * 125).ToString();
                PD_TextChange();
            }
        ...
        private void P_KO_S_IN_TB_TextChanged(object sender, EventArgs e)
        {
            try
            {
                if (P_KO_S_IN_TB.Text == String.Empty)
                {
                    P_KO_S_Amnt_TB.Clear();
                    P_TSA_S_TAmnt_TB.Clear();
                }
                P_KO_S_Amnt_TB.Text = (((Convert.ToInt64(P_KO_P_IN_TB.Text) * Convert.ToInt64(P_KO_S_IN_TB.Text)) / 100) * 120).ToString();
                PD_TextChange();
            }
        ...
        private void P_KO_S_Amnt_TB_TextChanged(object sender, EventArgs e)
        {
            try
            {
                P_STotAmnt();
        ...
        private void P_TTS_T_TStck_TB_TextChanged(object sender, EventArgs e)
        {
            try
            {
                P_DepoStck();
        ...
        private void P_SahiD_Stck_TB_TextChanged(object sender, EventArgs e)
        {
            try
            {
                P_Depo_TStck.Text = P_TTS_T_TStck_TB.Text;
        ...
        private void P_SahiD_Sale_TB_TextChanged(object sender, EventArgs e)
        {
            try
            {
                P_DepoTotSale();
        ...
        private void P_Depo_TStck_TextChanged(object sender, EventArgs e)
        {
            try
            {
                P_DepoSale();
        ...
        private void P_Rest_Btn_Click(object sender, EventArgs e)
        {
            try
            {
                PD_Clr();
        ...
        public void CAVI_PurTAmnt()
        {
            CAVI_TPSM_P_TAmnt_TB.Text = ((Convert.ToInt64(CAVI_JP4_P_Prc_TB.Text) + Convert.ToInt64(CAVI_JetA1_P_Prc_TB.Text)) * 30).ToString();
        }
        public void CAVI_TranTStck()
        {
            CAVI_TTS_T_TStck_TB.Text = ((Convert.ToInt64(CAVI_JP4_T_Stck_TB.Text) + Convert.ToInt64(CAVI_JetA1_T_Stck_TB.Text)) * 30).ToString();
        }
        public void CAVI_SaleTAmnt()
        {
            CAVI_TSA_S_TAmnt_TB.Text = ((Convert.ToInt64(CAVI_JP4_S_Amnt_TB.Text) + Convert.ToInt64(CAVI_JetA1_S_Amnt_TB.Text)) * 30).ToString();
        }
        public void CAVI_DepoTotAmnt()
        {
            CAVI_Depo_TSale_TB.Text = ((Convert.ToInt64(CAVI_IA_Sale_TB.Text) + Convert.ToInt64(CAVI_PA_Sale_TB.Text)) * 30).ToString();
        }
        public void CAVI_DepoStck()
        {
            CAVI_IA_Stck_TB.Text = (Convert.ToInt64(CAVI_TTS_T_TStck_TB.Text) / 60).ToString();
            CAVI_PA_Stck_TB.Text = (Convert.ToInt64(CAVI_TTS_T_TStck_TB.Text) / 60).ToString();
        }
        public void CAVI_DepoSale()
        {
            CAVI_IA_Sale_TB.Text = (Convert.ToInt64(CAVI_IA_Stck_TB.Text) * 130).ToString();
            CAVI_PA_Sale_TB.Text = (Convert.ToInt64(CAVI_PA_Stck_TB.Text) * 128).ToString();
        }
        public void CAVI_Clr()
        {
            CA_Date.Text = null; CAVI_JP4_P_IN_TB.Clear(); CAVI_JetA1_P_IN_TB.Clear(); CAVI_TPSM_P_TStck_TB.Clear(); CAVI_JP4_P_Prc_TB.Clear();
            CAVI_JetA1_P_Prc_TB.Clear(); CAVI_TPSM_P_TAmnt_TB.Clear(); CAVI_JP4_T_IN_TB.Clear(); CAVI_JetA1_T_IN_TB.Clear();
            CAVI_JP4_T_Stck_TB.Clear(); CAVI_JetA1_T_Stck_TB.Clear(); CAVI_TTS_T_TStck_TB.Clear(); CAVI_JP4_S_IN_TB.Clear();
            CAVI_JetA1_S_IN_TB.Clear(); CAVI_JP4_S_Amnt_TB.Clear(); CAVI_JetA1_S_Amnt_TB.Clear(); CAVI_TSA_S_TAmnt_TB.Clear();
            CAVI_IA_Stck_TB.Clear(); CAVI_PA_Stck_TB.Clear(); CAVI_Depo_Tstck_TB.Clear(); CAVI_IA_Sale_TB.Clear();
            CAVI_PA_Sale_TB.Clear(); CAVI_Depo_TSale_TB.Clear();
        }
        public void ChaklalaAvi_Result()
        {
            int j = 0;
            while (Res_GV.Rows.Count > j)
            {
                string dept = Res_GV.Rows[j].Cells[1].Value.ToString();
                if (dept == "Chaklala Aviation")
                {
                    try
                    {
                        SQL_Queires SQ = new SQL_Queires();
            ...
            {
                val += double.Parse(CAVI_GV.Rows[i].Cells[7].Value.ToString());
                i++;
            }
            if (val > 25000000)
            {
                String query = "Insert INTO AuditPlanRes(Departments, Frequency, Risk) VALUES('Chaklala Aviation', '" + HighFreq + "', '" + High + "')";
                SQL_Queires SQ = new SQL_Queires();
                SQ.InsertData(query);
                SQ.ShowGVData("SELECT * FROM AuditPlanRes", Res_GV);
            }
            ...
            {
                String query = "Insert INTO AuditPlanRes(Departments, Frequency, Risk) VALUES('Chaklala Aviation', '" + MedFreq + "', '" + Medium + "')";
                SQL_Queires SQ = new SQL_Queires();
                SQ.InsertData(query);
                SQ.ShowGVData("SELECT * FROM AuditPlanRes", Res_GV);
            }
            ...
            {
                String query = "Insert INTO AuditPlanRes(Departments, Frequency, Risk) VALUES('Chaklala Aviation', '" + LowFreq + "', '" + Low + "')";
                SQL_Queires SQ = new SQL_Queires();
                SQ.InsertData(query);
                SQ.ShowGVData("SELECT * FROM AuditPlanRes", Res_GV);
            }
